...
- приджойнитесь к заданию "HW1 Boolean Retrieval" в классруме. Для этого надо будет зайти туда по ссылке https://classroom.github.com/a/fC7tUNsG, найти себя в списке студентов и подключить свой аккаунт на гитхабе.
